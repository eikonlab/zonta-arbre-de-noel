  ...
  <div class="container">
    ...
    <div v-else>
      ...
      <div class="navigation-links">
        <router-link to="/message/1" class="nav-link">
          🎨 Vue Template 1
        </router-link>
        <router-link to="/message/2" class="nav-link">
          🎭 Vue Template 2
        </router-link>
      </div>
...
// Computed property to filter visible messages
...
onMounted(async () => {
  ...
  // Listen for message updates (hide/show)
