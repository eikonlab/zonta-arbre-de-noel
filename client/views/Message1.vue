<template>
  <div class="message-display">
    <div class="svg-container">
      ...
      >
        <defs>
          <path
            id="textPath1"
            d="M0 585.5C327.988 558.475 496.276 666.723 620.031 389.5C739 123 1026.4 89.006 1280 82.5"
          />
        </defs>
    ...
    <div class="navigation">
      <router-link to="/" class="nav-btn"> ← Retour au mur </router-link>
      <router-link to="/message/2" class="nav-btn nav-btn-alt">
        Template 2 →
      </router-link>
    </div>
  </div>
